...
// Note: Authentication is now handled by Keycloak in dashboard.html
// The Keycloak auth check runs before this script, so we can assume the user is authenticated
