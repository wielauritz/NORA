            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div class="flex justify-between items-center h-12">
                    ...
                    <div class="flex md:hidden items-center space-x-2">
                        ...
                        <!-- User Profile (Mobile) -->
                        <div class="relative">
                            <button onclick="toggleUserDropdown()" class="w-10 h-10 rounded-full bg-gradient-to-r from-primary to-secondary flex items-center justify-center text-white font-semibold text-sm hover:ring-2 hover:ring-primary/50 transition-all" id="userInitialsMobile" title="Profil-Menü">
                            </button>
                        </div>
                    </div>

                    <!-- Dropdowns (outside hidden containers so they work on mobile) -->
                    <!-- Friend Requests Dropdown -->
                    <div id="friendRequestsDropdown" class="hidden fixed md:absolute top-16 md:top-auto right-4 md:right-0 mt-0 md:mt-2 w-[calc(100vw-2rem)] md:w-96 max-w-sm md:max-w-none rounded-xl shadow-lg glass-effect dark:bg-slate-800 border border-gray-200 dark:border-slate-700 overflow-hidden z-50 max-h-96 overflow-y-auto">
                        <!-- Loading State -->
                    ...
                    <!-- User Dropdown Menu -->
                    <div id="userDropdown" class="hidden fixed md:absolute top-16 md:top-auto right-4 md:right-0 mt-0 md:mt-2 w-48 rounded-xl shadow-lg glass-effect dark:bg-slate-800 border border-gray-200 dark:border-slate-700 overflow-hidden z-50">
