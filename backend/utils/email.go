...
// SendVerificationCodeEmail sends an email with a 6-digit verification code
func (e *EmailService) SendVerificationCodeEmail(toEmail, firstName, verificationCode string) error {
	log.Printf("[EMAIL] Sending verification code email")
	subject := "NORA - E-Mail Bestätigung"

	// Base64 encoded logo (same as before)
	logoBase64 := ""
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%%">
            <tr>
                <td style="padding: 40px 20px;">
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #e5e7eb; background-color: #ffffff; border-radius: 8px;">
                        <tr>
                            <td align="center" style="padding: 40px 30px;">
                                <h1 style="margin: 0; padding: 0; font-size: 24px; font-weight: bold; color: #111827;">
                                    Hallo %s!
                                </h1>
                                <p style="margin: 20px 0 0 0; font-size: 16px; line-height: 24px; color: #374151;">
                                    Vielen Dank für deine Registrierung bei NORA. Um deine E-Mail-Adresse zu bestätigen, verwende bitte den folgenden Verifizierungscode:
                                </p>
                                <div style="margin: 30px 0; padding: 20px; background-color: #f3f4f6; border-radius: 8px;">
                                    <p style="margin: 0; font-size: 32px; font-weight: bold; color: #111827; letter-spacing: 8px; text-align: center; font-family: 'Courier New', monospace;">
                                        %s
                                    </p>
                                </div>
                                <p style="margin: 20px 0 0 0; font-size: 14px; line-height: 20px; color: #6b7280;">
                                    Dieser Code ist 24 Stunden gültig. Gib ihn in der NORA-App ein, um deine E-Mail-Adresse zu verifizieren.
                                </p>
                                <p style="margin: 20px 0 0 0; font-size: 14px; line-height: 20px; color: #6b7280;">
                        ...
                        <tr>
                            <td style="padding: 20px 30px; background-color: #f9fafb; border-top: 1px solid #e5e7eb; border-radius: 0 0 8px 8px;">
                                <p style="margin: 0; font-size: 12px; line-height: 18px; color: #9ca3af; text-align: center;">
                                    © 2025 NORA - Nordakademie Organizer. Alle Rechte vorbehalten.
                                </p>
                            </td>
                        </tr>
                    </table>
    ...
    </html>`, logoBase64, firstName, verificationCode)

	return e.sendEmail(toEmail, subject, htmlBody)
}

// SendPasswordResetCodeEmail sends an email with a 6-digit password reset code
func (e *EmailService) SendPasswordResetCodeEmail(toEmail, firstName, resetCode string) error {
	log.Printf("[EMAIL] Sending password reset code email")
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #e5e7eb; background-color: #ffffff; border-radius: 8px;">
                        <tr>
                            <td align="center" style="padding: 40px 30px;">
                                ...
                                <p style="margin: 20px 0 0 0; font-size: 16px; line-height: 24px; color: #374151;">
                                    Du hast eine Anfrage zum Zurücksetzen deines Passworts erhalten. Verwende bitte den folgenden Code, um dein Passwort zurückzusetzen:
                                </p>
                                <div style="margin: 30px 0; padding: 20px; background-color: #f3f4f6; border-radius: 8px;">
                                    <p style="margin: 0; font-size: 32px; font-weight: bold; color: #111827; letter-spacing: 8px; text-align: center; font-family: 'Courier New', monospace;">
                                        %s
                                ...
                                <p style="margin: 20px 0 0 0; font-size: 14px; line-height: 20px; color: #6b7280;">
                                    Dieser Code ist 1 Stunde gültig. Gib ihn in der NORA-App ein, um ein neues Passwort zu setzen.
                                </p>
                                <p style="margin: 20px 0 0 0; font-size: 14px; line-height: 20px; color: #6b7280;">
    ...
    </html>`, logoBase64, firstName, resetCode)
